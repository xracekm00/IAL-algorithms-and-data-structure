...
bst_init(&test_tree);
bool insert_result = bst_insert(&test_tree, 'H', create_integer_content(1));
bst_print_result(insert_result);
...
bst_print_result(insert_result);
bst_print_tree(test_tree);
insert_result = bst_insert(&test_tree, 'H', create_integer_content(8));
bst_print_result(insert_result);
bst_print_tree(test_tree);
ENDTEST
